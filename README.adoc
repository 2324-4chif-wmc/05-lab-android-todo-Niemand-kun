...
Zuerst einmal habe ich die Übung "1. Aufgabe" durchgearbeitet und in das Android Projekt eingebaut, danach wurden alle Todos geladen und korrekt angezeigt. 

image::image.png[first view]
